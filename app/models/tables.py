...
#config banco, removido github public
HOST = ''
USER = ''
PASSWORD = ''
DATABASE = ''
...
#recupera produto para listagem unica, quando clicado sobre
...
#recupera id do produto para edição
...
#estensões permitidas para upload e imagem
def extensoes(filename):
    ALLOWED_EXTENSIONS = set(['png', 'jpg', 'jpeg'])
    return '.' in filename and \
           filename.rsplit('.', 1)[1] in ALLOWED_EXTENSIONS

#Gera home imagem de acordo com timestamp atual e faz um hash 256
...
#função salvar imagem , foto loja ou foto produto, não toque.
...
#Listagem de produtos por categoria index
...
#Informações perfil produtor publico
...
#Informações para perfil, quando logado
...
#Produtos publicos de determinado produtor
...
#listagem de categorias no registro de produto
def menu_categorias():
    lista_categorias = []
    try:
       cur = con.cursor()   
...
#Registra pedido comprador, e atualiza estoque de acordo com a quantidade disponivel ou desativa
...
#Recupera pedidos, tela comprador > pedidos pendentes
...
#Recupera vendas / Perfil produtor > Vendas
...
#Atualiza o status do produto se estoque for maior que 0/ Ação ativar desativar pelo perfil do produtor
...
#Recupera produtos de acordo com termo de pesquisa
...
#Recupera vendas pendente / Tela produtor > Notificações
...
#Function para alterar status do pedido / ação efetuada pelo dono do produto
...
#Function para atualizar produtos / ação efetuada pelo dono do produto
